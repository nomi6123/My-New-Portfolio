...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-[url('/skill.jpg')] bg-cover bg-no-repeat bg-center text-white overflow-hidden">
      ...
      {/* Simplified background elements - reduced from 30 to 12 */}
            ...
            >
              <div className="relative p-8 rounded-3xl bg-gradient-to-br from-gray-900/60 via-black/50 to-purple-900/60 backdrop-blur-xl border border-gray-700/30">
                ...
                <div className="relative z-10">
                  <h2 className="text-4xl md:text-5xl font-black text-transparent bg-gradient-to-r from-cyan-400 via-purple-500 to-fuchsia-400 bg-clip-text mb-6 uppercase tracking-wider">
                    Muhammad Noman
                  </h2>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={index}
                    className="p-4 rounded-xl bg-gradient-to-br from-fuchsia-500/10 to-cyan-500/10 backdrop-blur-sm border border-fuchsia-400/20 text-center hover:scale-105 transition-transform duration-300"
                  >
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-6 cursor-pointer">
                <Link href="/Privacy" legacyBehavior>
                  <a className="text-sm font-semibold text-white hover:text-fuchsia-400 transition-colors duration-300 relative group hover:scale-105">
                    Privacy Policy
                ...
                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-fuchsia-400 to-cyan-400 flex items-center justify-center">
